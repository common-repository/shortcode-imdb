            ...
            <main>
                ...
                <section id="content1">
                    ...
                    <?php if ($pre_op == "show"): ?>
                        ...
                        <div style="text-align: center;"><h3 style="color: red;font-weight: 800 !important;"><a href="https://pluginpress.net/tag/shortcode-imdb"  target="_blank">All premium products are half price until the end of the year!</a></h3></div>
                        <div style="text-align: center;font-size:25px;font-weight: 999; margin-bottom: 20px"><a href="https://pluginpress.net/tag/geekpress" target="_blank">Watch and support for the next</a> - Movie, Game, TV Show and Comic Database on the road</div>
                        <div style="text-align: center;"><iframe width="560" height="315" src="https://www.youtube.com/embed/shwGFBWA7Qo" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
                            ...
                            <div class="dashcard card-1 <?php echo $tab_img?>">
                                ...
                                <div class="dashcard-info">
                                    <div class="dashcard-about">
                                        ...
                                        <div class="dashcard-time"><b>£19.99</b> <small style="text-decoration:line-through ">£39.99</small></div>
                                    </div>
                            ...
                            <div class="dashcard card-2 <?php echo $woo_img?>">
                                ...
                                <div class="dashcard-info">
                                    <div class="dashcard-about">
                                        ...
                                        <div class="dashcard-time"><b>£12.99</b>  <small style="text-decoration:line-through ">24.99</small></div>
                                    </div>
                            ...
                            <div class="dashcard card-3 <?php echo $list_img?>">
                                ...
                                <div class="dashcard-info">
                                    <div class="dashcard-about">
                                        ...
                                        <div class="dashcard-time"><b>£14.99</b>  <small style="text-decoration:line-through ">29.99</small></div>
                                    </div>
                            ...
                            <div class="dashcard card-4 <?php echo $popup_img?>">
                                ...
                                <div class="dashcard-info">
                                    <div class="dashcard-about">
                                        ...
                                        <div class="dashcard-time"><b>£4.99</b>  <small style="text-decoration:line-through ">9.99</small></div>
                                    </div>
